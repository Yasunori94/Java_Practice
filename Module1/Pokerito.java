...
public class Pokerito {
    public static void main(String[] args) {
        ...
        */
        ...
        if(card1.equals(yourCard)){
            yourMatches += 1;
        }
        if(card2.equals(yourCard)){
            yourMatches += 1;
        }
        if(card3.equals(yourCard)){
            yourMatches += 1;
        }
        if(card4.equals(yourCard)){
            yourMatches += 1;
        }

        if(card1.equals(computerCard)){
            computerMatches += 1;
        }
        if(card2.equals(computerCard)){
            computerMatches += 1;
        }
        if(card3.equals(computerCard)){
            computerMatches += 1;
        }
        if(card4.equals(computerCard)){
            computerMatches += 1;
        }
